...
const menuItems = [
  { icon: LayoutDashboard, label: 'Dashboard', path: '/dashboard/professional' },
  { icon: Calendar, label: 'Agenda', path: '/dashboard/professional/agenda' },
  { icon: Users, label: 'Pacientes', path: '/dashboard/professional/pacientes' },
  { icon: FileText, label: 'Prontuários', path: '/dashboard/professional/prontuarios' },
];
