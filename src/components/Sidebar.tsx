...
const menuItems = [
  ...
  { icon: Calendar, label: 'Consultas', path: '/dashboard/patient/consultas' },
  { icon: Plus, label: 'Agendar Consulta', path: '/dashboard/patient/agendamento' },
  { icon: ClipboardList, label: 'Histórico', path: '/dashboard/patient/historico' },
  { icon: Video, label: 'Teleconsulta', path: '/dashboard/patient/teleconsulta' },
  { icon: Bell, label: 'Notificações', path: '/dashboard/patient/notificacoes' },
];
